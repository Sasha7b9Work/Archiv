...
cd scripts/vs_gui
@echo on
cmake ../../VS/CMakeLists.txt -B../../generated/GUI  -G "Visual Studio 16 2019" -A Win32 -DCMAKE_BUILD_TYPE=Debug
@echo off

:BUILDING
if %isBuild%==0 goto EXIT
@echo on
MSBuild.exe ../../generated/GUI/S8-53M_GUI.sln -clp:ErrorsOnly;WarningsOnly -nologo /m
@echo off
goto EXIT
