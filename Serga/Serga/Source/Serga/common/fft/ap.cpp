...
#pragma warning(disable:4706)
    while((str=fgets(buf, sizeof(buf), f)) != NULL)     // Здесь мною было внесено исправление. Первоначально строка выглядела так:
                                                        // while(str=fgets(buf, sizeof(buf), f))        Шевченко А.В., 04.02.2010
                                                        // Причина внесения исправление - варнинг 4706
    {
